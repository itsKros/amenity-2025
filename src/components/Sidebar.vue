<template>
    <div class="sidebar w-4/6 md:w-1/6 absolute  z-10">
        <div id="moreAmenity" @click="moreAmenityList = !moreAmenityList, hideDetails()" :class="[moreAmenityList == true ? '' : 'closed']" class="button bg-primary flex flex-row justify-between items-center w-full text-white tracking-widest text-xs cursor-pointer px-2 py-1 relative select-none">
        ...
        <div class="list bg-white pt-3 pb-2 md:p-2 pl-4 pr-0 md:py-4  rounded-b-lg select-none" v-if="moreAmenityList">
            <ul class="text-xs relative select-none overflow-y-scroll md:overflow-hidden">
                ...
                <li class="text-xs cursor-pointer relative" :class="[isSmartHomePkg == true ? 'text-primary' : '']" @click="isSmartHomePkg=!isSmartHomePkg, hideDetailsEXSHP()">
                    <span>Available Smart Home Packages</span> <i class="fal ml-1" :class="[isSmartHomePkg == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs cursor-pointer relative" :class="[isFrndFmlyApt == true ? 'text-primary' : '']" @click="isFrndFmlyApt = !isFrndFmlyApt, hideDetailsEXFFA()">
                ...
                <li class="text-xs cursor-pointer relative" :class="[isDigiPkgLock == true ? 'text-primary' : '']" @click="isDigiPkgLock = !isDigiPkgLock, hideDetailsEXDPL()">
                    <span>Digital Package Lockers</span> <i class="fal ml-1" :class="[isDigiPkgLock == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs cursor-pointer relative" :class="[isSmartBuildAccess == true ? 'text-primary' : '']" @click="isSmartBuildAccess = !isSmartBuildAccess, hideDetailsEXSBA()">
                    <span>Smart Building Access</span> <i class="fal ml-1" :class="[isSmartBuildAccess == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs cursor-pointer relative" :class="[isEVCharging == true ? 'text-primary' : '']" @click="isEVCharging = !isEVCharging, hideDetailsEXEVC()">
                    <span>EV Charging Stations</span> <i class="fal ml-1" :class="[isEVCharging == true ? 'fa-minus-circle' : 'fa-plus-circle ']"></i>
                </li>
                <li class="text-xs cursor-pointer relative" :class="[isSolarArray == true ? 'text-primary' : '']" @click="isSolarArray = !isSolarArray, hideDetailsEXSOL()">
                ...
                <li class="text-xs cursor-pointer relative" :class="[isDigiConServ == true ? 'text-primary' : '']" @click="isDigiConServ=!isDigiConServ, hideDetailsEXDCS()">
